package uz.greenwhite.smartup5_trade.m_vp.ui;
...
public class OutletVisitTuningFragment extends MoldTuningSectionFragment {
    ...
    private OutletFilter getFilter() {
        OutletVisitFragment content = Mold.getContentFragment(getActivity());
